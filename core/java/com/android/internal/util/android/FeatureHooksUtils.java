...
public class FeatureHooksUtils {
    ...
    public static boolean hasSystemFeature(String name, int version, boolean hasSystemFeature) {
        if (SystemProperties.getBoolean(PropImitationHooks.ENABLE_PIXEL_PROPS, true)) {
            String packageName = ActivityThread.currentPackageName();
            if (packageName != null) {
                boolean isGPhotosSpoofEnabled = SystemProperties.getBoolean(PropImitationHooks.SPOOF_PIXEL_GPHOTOS, true);
